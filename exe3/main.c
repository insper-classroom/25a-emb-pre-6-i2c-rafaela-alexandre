...
const int BMP280_CHIP_ADDR = 0x76;
...
void i2c_task(void *p) {
    ...
    i2c_write_blocking(i2c_default, BMP280_CHIP_ADDR, &reg_address, 1, true); 
    i2c_read_blocking(i2c_default, BMP280_CHIP_ADDR, buffer, 1, false);
    printf("BMP280 ID: 0x%X \n", buffer[0]);
